...
describe 'archive::artifactory' do
  ...
  context 'artifactory archive with defaults' do
    ...
    it do
      should contain_archive('/opt/app/example.zip').with(:path => '/opt/app/example.zip',
    ...
    it do
      should contain_file('/opt/app/example.zip').with(:owner => '0',
                                                       :group => '0',
                                                       :mode => '0640',
  ...
  context 'artifactory archive with path' do
    ...
    it do
      should contain_file('/opt/app/example.zip').with(:owner => 'app',
                                                       :group => 'app',
                                                       :mode => '0400',
                                                       :require => 'Archive[/opt/app/example.zip]',)
    end
